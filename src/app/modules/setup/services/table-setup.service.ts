...
export class TableSetupService {
  ...
  create(data): Observable<any> {
    return this.httpClient
      .post<any>(this.baseUrl + 'TableSetups/Save', data)
      .pipe(catchError(this.handleError));
  }

  update(data): Observable<any> {
    return this.httpClient
      .put<any>(this.baseUrl + 'TableSetups/' + data.id, data)
      .pipe(catchError(this.handleError));
  }

  getById(id): Observable<any> {
    return this.httpClient
      .get<any>(this.baseUrl + 'TableSetups/' + id)
      .pipe(catchError(this.handleError));
  }
  delete(id: number): Observable<void> {
    return this.httpClient
      .delete<void>(this.baseUrl + 'TableSetups/Remove?id=' + id)
      .pipe(catchError(this.handleError));
  }
  ...
  getPagination(page?, itemPerPage?, searchKey?) {
    ...
    return this.httpClient
      .get<any>(`${this.baseUrl}TableSetups/GetAll`, {
        params,
      })
