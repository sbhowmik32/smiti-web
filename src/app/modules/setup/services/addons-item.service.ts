...
export class AddonsItemService {
  ...
  createAddonsItem(data): Observable<any> {
    return this.httpClient
      .post<any>(this.baseUrl + 'AddOnsItems/Save', data)
      .pipe(catchError(this.handleError));
  }

  deleteAddonsItem(id: number): Observable<void> {
    return this.httpClient
      .delete<void>(this.baseUrl + 'AddOnsItems/Remove?id=' + id)
      .pipe(catchError(this.handleError));
  }

  getAddonsItemPagination(page?, itemPerPage?, searchKey?) {
    ...
    return this.httpClient.get<any>(`${this.baseUrl}AddOnsItems/GetAll`,{
          params,
