...
export class RefundReportService {
  ...
  getEventRefundSummaryReport(
    ...
    return this.http.get(
      `${environment.apiUrl}v1/Refund/EventRefundSummaryReport`,
      {
        responseType: 'blob',
        params: params,
      }
  ...
  getEventRefundDetailReport(
    ...
    return this.http.get(
      `${environment.apiUrl}v1/Refund/EventRefundDetailReport`,
      {
        responseType: 'blob',
        params: params,
      }
  ...
  getServiceRefundSummaryReport(
    ...
    params = params.set('MembershipNo', membershipNo);
    return this.http.get(
      `${environment.apiUrl}v1/Refund/ServiceRefundSummaryReport`,
      {
        responseType: 'blob',
        params: params,
      }
  ...
  getServiceRefundDetailReport(
    ...
    return this.http.get(
      `${environment.apiUrl}v1/Refund/ServiceRefundDetailReport`,
      {
        responseType: 'blob',
        params: params,
      }
  ...
  getVenueBookingRefundSummaryReport(
    ...
    params = params.set('MembershipNo', membershipNo);
    return this.http.get(
      `${environment.apiUrl}v1/Refund/VenueBookingRefundSummaryReport`,
      {
        responseType: 'blob',
        params: params,
      }
  ...
  getVenueBookingRefundDetailReport(
    ...
    return this.http.get(
      `${environment.apiUrl}v1/Refund/VenueBookingRefundDetailReport`,
      {
        responseType: 'blob',
        params: params,
      }
